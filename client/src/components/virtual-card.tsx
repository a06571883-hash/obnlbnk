...
export default function VirtualCard({ card }: { card: Card }) {
  ...
  return (
    ...
    >
      <div
        className={`relative h-[140px] w-full rounded-xl ${cardColors[card.type as keyof typeof cardColors]} p-4 text-white shadow-xl overflow-hidden backdrop-blur-sm`}
        style={{
          boxShadow: `
