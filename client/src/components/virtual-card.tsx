...
export default function VirtualCard({ card }: { card: Card }) {
  ...
  return (
    ...
    >
      <div
        className={`relative h-36 sm:h-44 w-full rounded-xl ${cardColors[card.type as keyof typeof cardColors]} p-4 sm:p-6 text-white shadow-xl transform transition-all duration-300`}
        style={{
          boxShadow: `
      ...
      >
        <div className="flex flex-col justify-between h-full">
          <div className="space-y-1">
            ...
            <div className="text-sm sm:text-xl font-bold tracking-wider">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs">
              ...
              <div>
                <div className="text-[9px] opacity-80">Expires</div>
                <div className="text-[11px] font-semibold">{card.expiry}</div>
              </div>
            </div>
            <div className="flex space-x-0.5">
              <Dialog>
                <DialogTrigger asChild>
                  <Button size="sm" variant="ghost" className="flex-1 text-white hover:bg-white/20 bg-white/10 backdrop-blur-sm text-[9px] sm:text-xs py-0.5 h-4 sm:h-5">
                    <ArrowUpCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3 mr-0.5" />
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <Button size="sm" variant="ghost" className="flex-1 text-white hover:bg-white/20 bg-white/10 backdrop-blur-sm text-[9px] sm:text-xs py-0.5 h-4 sm:h-5">
                    <ArrowDownCircle className="h-2.5 w-2.5 sm:h-3 sm:w-3 mr-0.5" />
