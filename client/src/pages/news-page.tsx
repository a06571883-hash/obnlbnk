...
const demoNews: NewsItem[] = [
  {
    id: 1,
    title: "Bitcoin достиг нового максимума в 2025 году",
    content: "Ведущая криптовалюта преодолела отметку в $85,000, установив новый рекорд этого года. Аналитики связывают рост с увеличением институционального интереса и предстоящим халвингом.",
  ...
  {
    id: 2,
    title: "НБУ опубликовал новый прогноз по курсу гривны",
    content: "Национальный банк Украины представил обновленный прогноз курса гривны на 2025 год. Регулятор ожидает стабилизации курса в коридоре 40-42 гривен за доллар.",
    date: "27 февраля 2025",
    category: 'fiat',
    source: 'FinanceUA'
  },
  {
    id: 3,
    title: "Ethereum 2.0 показывает рекордное количество стейкинга",
    content: "Количество эфира в стейкинге достигло исторического максимума. Аналитики отмечают растущее доверие к сети после успешных обновлений протокола.",
    date: "27 февраля 2025",
    category: 'crypto',
    source: 'ETHNews'
  },
  {
    ...
    content: "Европейский союз анонсировал новую регуляторную базу для криптовалютного рынка. Изменения вступят в силу с 1 марта 2025 года.",
    date: "27 февраля 2025",
    category: 'crypto',
  ...
  {
    id: 5,
    title: "Межбанковский рынок демонстрирует высокую активность",
    content: "Объемы торгов на межбанковском валютном рынке достигли максимальных значений за последние месяцы. Эксперты отмечают рост деловой активности.",
    date: "27 февраля 2025",
    category: 'fiat',
    source: 'BankNews'
  }
